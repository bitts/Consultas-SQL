/*
	PLT059 - Script para Boletim por Turma
	Create By Bitts
	(23/06/2017)
...
DECLARE @CODPERLET VARCHAR(5) = '2017';
DECLARE @TRIMESTRE_ INT = 3;
DECLARE @CODTURMA_ VARCHAR(5) = 'EF71';
...
SELECT
	...
	A.CODSTATUSRES,
	C.DIASLETIVOS,
	N1 = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 1 THEN ISNULL(CONVERT(VARCHAR, N1.NOTA),'-') ELSE '' END)),
	F1 = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 1 THEN ISNULL(CONVERT(VARCHAR, F1.FALTAS),'0') ELSE '' END)), 

	N2 = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 2 THEN ISNULL(CONVERT(VARCHAR, N2.NOTA),'-') ELSE '' END)),
	F2 = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 2 THEN ISNULL(CONVERT(VARCHAR, F2.FALTAS),'0') ELSE '' END)), 
	
	N3 = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 3 THEN ISNULL(CONVERT(VARCHAR, N3.NOTA),'-') ELSE '' END)),
	F3 = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 3 THEN ISNULL(CONVERT(VARCHAR, F3.FALTAS),'0') ELSE '' END)), 
	
	MA = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 3 THEN ISNULL(CONVERT(VARCHAR, MA.NOTA),'-') ELSE '' END)),
	EX = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 3 THEN ISNULL(CONVERT(VARCHAR, EX.NOTA),'-') ELSE '' END)),
	NF = CONVERT(VARCHAR, (CASE WHEN @TRIMESTRE_ >= 3 THEN ISNULL(CONVERT(VARCHAR, (ISNULL(F1.FALTAS,0) + ISNULL(F2.FALTAS,0) +ISNULL(F3.FALTAS,0))),'-') ELSE '' END)),
	MEDIAANUAL = (
		CASE 
